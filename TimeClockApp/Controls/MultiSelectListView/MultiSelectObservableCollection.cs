...
namespace TimeClockApp.Controls.MultiSelectListView
{
    ...
    {
        public MultiSelectObservableCollection() : base() { }

        public MultiSelectObservableCollection(IEnumerable<T> collection) : base(collection.Select(c => new SelectableItem<T>(c))) { }

        public MultiSelectObservableCollection(IEnumerable<SelectableItem<T>> collection) : base(collection) { }
